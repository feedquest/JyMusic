...
$api = new PHP_CRUD_API(array(
	...
	'charset'=>'utf8',
	'table_authorizer'=>function($cmd,$db,$tab) { return (($cmd=='read'||$cmd=='list') && ($tab=='url'||$tab=='items'||$tab=='songlist'||$tab=='recommended_album'||$tab=='pic'||$tab=='all_albums'||$tab=='gedan_info')); },
));
// $api->executeCommand();
